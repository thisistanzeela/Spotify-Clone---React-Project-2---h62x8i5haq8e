...
function AlbumSongs() {
  ...
  const [playing, setPlaying] = useState(false); // Initialize playing state
  ...
  //       // Set the current song to the selected item and play it
  //       setCurrent(item);
  //       setPlaying(true);
  //     } else {
  //       // Toggle play/pause when clicking on the current song
  //       setPlaying(!playing);
  //     }
  //   }
  // };
