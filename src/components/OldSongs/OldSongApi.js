...
async function fetchData() {
  const songsReleasedIn1980 = await fetchSongsByReleaseDate(
    "1980-01-01T00:00:00.000Z"
  );
  const songsReleasedIn1981 = await fetchSongsByReleaseDate(
    "1981-01-01T00:00:00.000Z"
  );
  const songsReleasedIn1971 = await fetchSongsByReleaseDate(
    "1971-01-01T00:00:00.000Z"
  );
  const songsReleasedIn1975 = await fetchSongsByReleaseDate(
    "1975-01-01T00:00:00.000Z"
  );
  const songsReleasedIn1976 = await fetchSongsByReleaseDate(
